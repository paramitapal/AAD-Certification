...
public class CustomReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_RANDOM_NUMBER =
            BuildConfig.APPLICATION_ID + ".ACTION_RANDOM_NUMBER";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent.getExtras()!=null) {
            int number = intent.getExtras().getInt(ACTION_RANDOM_NUMBER, 0);
            numberSqr = (number* number);
            Log.d("TAG","sqrt of the number "+numberSqr);
        }
        ...
        if (intentAction != null) {
            ...
            switch (intentAction){
                ...
                case ACTION_CUSTOM_BROADCAST:
                    toastMessage =
                            context.getString(R.string.custom_broadcast_toast)+ ("Square of random number: "+numberSqr);
                    break;
            }
